...
import com.jfixby.r3.api.ui.UnitsMachineComponent;
...
// }
	...
	private void onUIStart () {
		final boolean disableLogo = SystemSettings.getFlag(Settings.DisableLogo);

		if (!disableLogo) {
			final Intent intent = UnitsMachine.newIntent(Names.newID("com.jfixby.r3.fokker.screens.RedTriplaneLogoScreen"));
			UnitsMachine.nextUnit(intent);
		} else {
			FokkerUIManager.onUIStart();
		}
