...
import com.jfixby.r3.fokker.core.unit.geo.RedRectangleComponent;
...
// this.zoom = 1d;
	...
	final ID asset_id = SystemSettings.getSystemAssetID(Assets.SPRITE_BLACK);
	...
	public void renderAperture () {
		...
		if (this.debug_mode) {
			RenderMachine.beginRasterMode(BLEND_MODE.GDX_DEFAULT, this.aperture_opacity * 0.3);
		} else {
			RenderMachine.beginRasterMode(BLEND_MODE.GDX_DEFAULT, this.aperture_opacity);
		}
		...
		//
		RenderMachine.endRasterMode(BLEND_MODE.GDX_DEFAULT);
