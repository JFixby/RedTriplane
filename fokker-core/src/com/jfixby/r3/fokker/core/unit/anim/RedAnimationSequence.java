...
package com.jfixby.r3.fokker.core.unit.anim;
...
// this.frame.setPosition(this.current_anchor_A);
			this.offset.set(this.current_anchor_A);
...
// this.frame.setPosition(this.current_position);
	...
	private void updateLinear () {
		...
		Geometry.parametrize(this.current_anchor_A, this.progress, this.current_anchor_B, this.current_position);
