...
public class LineRenderer {
	...
	private void drawLine (final ReadOnlyFloat2 screen_point_a, final ReadOnlyFloat2 screen_point_b) {
		final float f_Ax = SpritesRenderer.round(screen_point_a.getX());
		final float f_Ay = SpritesRenderer.round(screen_point_a.getY());
		final float f_Bx = SpritesRenderer.round(screen_point_b.getX());
		final float f_By = SpritesRenderer.round(screen_point_b.getY());
